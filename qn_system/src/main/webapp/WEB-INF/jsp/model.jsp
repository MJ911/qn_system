...
<div id="main" > 
    ...
    <div id="div_middle" style="color:black;overflow:scroll;overflow-x:hidden;">
	   ...
	   <form action="/qn_system/questionnaire_list" method="post">
	   	...
	   	<center><input type="submit" value="用户子模版" style="margin-top:40px;"class="button blue bigrounded" <c:if test="${questionnaire.questionnaire_type == '0'}">onclick='/qn_system/create_questionnaireFrommodel/questionnaire_id'</c:if>/>
