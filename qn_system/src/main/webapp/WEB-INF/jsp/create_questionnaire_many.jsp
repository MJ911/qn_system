...
<div id="main" > 
				...
				<div  class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
					...
					<div width="60%" style="float:left">
					    <ul class="nav navbar-nav menu__list">
					        <li style="color:white" class="active menu__item menu__item--current"><a class="menu__link" href="home.html">首页<span class="sr-only">(current)</span></a></li>				
							<li id="qn"style="color:white" class=" menu__item"><a class="menu__link" href="#">投票集</a></li>
							<li style="color:white" class=" menu__item"><a class="menu__link" >问卷集</a></li>
					        <li style="color:white" class=" menu__item"><a class="menu__link" href="#">问卷模板</a></li>
					        <li style="color:white" class=" menu__item"><a class="menu__link" href="#">帮助</a></li>
					...
					<div width="10%"style="float:left">
						<ul class="nav navbar-nav menu__list">
					        <li class=" menu__item"><a class="menu__link" href="login1.html">登录</a></li>
    ...
    <div id="div_middle">
	    <iframe id="iframe1" frameboder="no" border="0" src="/qn_system/createSerch" style="width:100%;height:100%;"> </iframe>   
