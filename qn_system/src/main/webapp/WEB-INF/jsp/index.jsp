	...
	<div id="main">
		...
		<div id="div_middle">
			<div id="div_label1">
				<ul style="list-style-type: none">
					<div id="div_label2">
						<li><font size="10px" color="white">不止问卷调查 / 在线考试</font></li>
						<div id="div_label2">
							<div id="div_label2">
								<li><font size="5px" color="orange">4,125 28.35</font> <font
									size="5px" color="white"> 万用户已在问卷强上回收或作答</font> <font
									size="5px" color="orange">28.35</font> <font size="5px"
									color="white">亿份答卷</font></li>
								<div id="div_label2">
									<li align="center"><input type="submit" id="button"
										value="立即使用"
										style="border: none; width: 200px; height: 50px; border-radius: 30px; background: orange; color: white;size=6px"
										onclick="Tocreate_choice()" /></li>
								</div>
				</ul>
			</div>
		</div>
		...
		<div id="foot">
			...
			<div id="footer" style="opacity: 1; right: -5px; top: -3px;">
				<ul>
					<li><font color="orange">Copyright©2019 第三组 All Rights
							Reserved</font></li>
