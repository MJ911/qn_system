...
$(document).ready(function(e) {
			 $('#addquerstions').change(function() {
		            ...
		            movie_box = $(movie_box).append(' <input class="q_name" type="hidden" name="question_list[' + question_num + '].question_name" value="vote"/> ');
		            ...
		            switch (index) {
		                ...
		                case "2": //问答
		                    ...
		                    wjdc_list = $(wjdc_list).append(' <li><div class="tm_btitlt"><i class="nmb">' + '</i>. <i class="btwenzi"></i><span class="tip_wz">' + danxuan + '</span></div></li>');
